...
### ⟳ NUM_PC_L3_012 — Reverse-engineer from multi-variable outcome
...
### ⟳ NUM_AV_L2_022 — Reverse average (find missing value)
...
### ⟳ NUM_MA_L3_027 — Three alloys melted together
...
### ⟳ NUM_CI_L2_033 — Compare two plans (stripped from old L3)
...
### ⟳ NUM_TW_L2_037 — Efficiency multiplier (moved from L3)
...
### ⟳ NUM_TW_L3_040 — Three equations for three rates
...
### ⟳ NUM_PT_L2_049 — Three-phase fill (stripped from L3)
...
### ⟳ NUM_PN_L2_053 — Multi-constraint counting (moved from L3)
...
### ⟳ NUM_NS_L2_061 — Rule identification (moved from L3)
...
### ⟳ NUM_MS2_L2_073 — Cost with wastage (stripped from L3)
...
### ⟳ NUM_MS2_L3_074 — Path around rectangle
...
### ⟳ NUM_MS3_L2_077 — Capacity with efficiency (stripped from L3)
